...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Bastoji address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bastoji",               "masternode",             &masternode,             true,  {} },
    { "bastoji",               "masternodelist",         &masternodelist,         true,  {} },
    { "bastoji",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bastoji",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bastoji",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bastoji",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
