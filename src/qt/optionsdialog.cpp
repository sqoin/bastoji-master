    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BTJ-light"), QVariant("light"));
    ui->theme->addItem(QString("BTJ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BTJ-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BTJ-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BTJ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BTJ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BTJ-traditional"), QVariant("trad"));
