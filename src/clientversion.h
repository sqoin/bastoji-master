...
//! These need to be macros, as clientversion.cpp's and bastoji*-res.rc's voodoo requires it
...
/**
 * bastojid-res.rc includes this file, but it cannot cope with real c++ code.
