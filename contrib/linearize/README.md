# Linearize
Construct a linear, no-fork, best version of the Bastoji blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install bastoji_hash

https://github.com/bastojipay/bastoji_hash
...
JSON-RPC server. Running `bastojid` or `bastoji-qt -server` will be sufficient.
...
* `input`: bastojid blocks/ directory containing blkNNNNN.dat
