...
This mechanism has been integrated into Bitcore-Node-Bastoji which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bastojipay/insight-api-bastoji#web-socket-api](https://github.com/bastojipay/insight-api-bastoji#web-socket-api)
* API: [https://github.com/bastojipay/insight-api-bastoji#instantsend-transactions](https://github.com/bastojipay/insight-api-bastoji#instantsend-transactions)
...
By default, the Bastoji Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bastoji Core daemon:
