...
This document provides guidelines for internationalization of the Bastoji Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bastoji_en.ts` remains unchanged.
