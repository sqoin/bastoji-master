...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 BTJ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 BTJ in block rewards plus fees, but
        ...
        # Send 100 BTJ with subtract fee from amount
        ...
        # Sendmany 100 BTJ with subtract fee from amount
